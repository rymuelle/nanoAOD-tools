...
config.General.requestName = '2016_ST_ST_tW_top_5f_inclusiveDecays_13TeV_ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8__deepflavour_bff'
...
config.Data.outputDatasetTag = 'ST_tW_top_5f_inclusiveDecays_13TeV_deepflavour_bff'
