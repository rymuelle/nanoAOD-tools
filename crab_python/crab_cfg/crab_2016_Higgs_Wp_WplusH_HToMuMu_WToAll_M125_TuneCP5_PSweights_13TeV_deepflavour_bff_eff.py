...
config.General.requestName = '2016_Higgs_Wp_WplusH_HToMuMu_WToAll_M125_TuneCP5_PSweights_13TeV_deepflavour_bff_eff'
...
config.Data.outputDatasetTag = 'Wp_deepflavour_bff_eff'
