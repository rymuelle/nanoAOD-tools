...
config.General.requestName = '2017_data_SingleMuonB_SingleMuon_deepflavour_bff'
config.General.transferLogs = False
config.General.workArea ='work_areas'
config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'PSet.py'
config.JobType.scriptExe = 'bash_scripts/bash_script_2017_bff_deepflavour_isMC_False.sh'
...
config.Data.outputDatasetTag = 'SingleMuonB_deepflavour_bff'
