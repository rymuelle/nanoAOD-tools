...
config.General.requestName = '2016_ST_ST_tW_top_5f_inclusiveDecays_13TeV_ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8__deepcsv_bff'
...
config.Data.outputDatasetTag = 'ST_tW_top_5f_inclusiveDecays_13TeV_deepcsv_bff'
