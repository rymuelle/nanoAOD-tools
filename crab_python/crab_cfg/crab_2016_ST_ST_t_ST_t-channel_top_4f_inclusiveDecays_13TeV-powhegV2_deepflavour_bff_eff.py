...
config.General.requestName = '2016_ST_ST_t_ST_t-channel_top_4f_inclusiveDecays_13TeV-powhegV2_deepflavour_bff_eff'
...
config.Data.outputDatasetTag = 'ST_t_deepflavour_bff_eff'
