...
config.General.requestName = '2017_ST_ST_anti_ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-pow_deepflavour_bff_eff'
...
config.Data.outputDatasetTag = 'ST_anti_deepflavour_bff_eff'
