...
config.General.requestName = '2017_ST_ST_ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-_deepflavour_bff_eff'
...
config.Data.outputDatasetTag = 'ST_deepflavour_bff_eff'
